...
fun ProxyScreen(
    ...
    SettingsSubPage(titleRes = R.string.probe_proxy, onBack = onBack) {
        item {
            AppCard(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                AppText(
                    text = stringResource(R.string.probe_proxy_hint),
        ...
        item {
            AppTextField(
                state = input,
                label = stringResource(R.string.probe_proxy),
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = tokens.screenPadding, vertical = tokens.itemSpacing),
                errorText = if (showError) stringResource(R.string.probe_proxy_invalid) else null,
            )
        }

...
fun ProfileEditorScreen(
        ...
        topBar = {
            AppTopBar(
                title = stringResource(
                    if (isNew) R.string.profile_editor_new_title else R.string.profile_editor_title,
                ),
        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    AppTextField(
                        state = name,
                        label = stringResource(R.string.profile_editor_name),
                        errorText = if (nameError) stringResource(R.string.profile_editor_save_empty_name) else null,
                    )
                    AppTextField(
                        state = userAgent,
                        label = stringResource(R.string.profile_editor_user_agent),
                        errorText = if (uaError) stringResource(R.string.profile_editor_save_empty_ua) else null,
                    )
                }
            }

            item { SectionTitle(text = stringResource(R.string.profile_editor_headers)) }
            item {
                Column(
                    modifier = Modifier.padding(
                        horizontal = tokens.screenPadding,
                    ...
                    AppTextField(
                        state = headersText,
                        label = stringResource(R.string.profile_editor_headers),
                        singleLine = false,
                        supportingText = stringResource(R.string.profile_editor_headers_hint),
                    )
                }
            }

            item { SectionTitle(text = stringResource(R.string.profile_editor_protocols)) }
            item { ProtocolChips(protocols) { protocols = it } }
            item {
                AppText(
                    text = stringResource(R.string.profile_editor_protocols_hint),
            ...
            if (!isBuiltin) {
                item {
                    AppTextButton(
                        text = stringResource(R.string.profile_editor_delete),
    ...
    AppDialog(
        ...
        title = stringResource(R.string.profile_editor_delete_title),
        summary = stringResource(R.string.profile_editor_delete_summary),
        confirmText = stringResource(R.string.profile_editor_delete),
        onConfirm = {
            showDelete = false
            onDelete()
        },
...
private fun CurlImportCard(
    ...
    Column {
        AppTextButton(
            text = stringResource(R.string.profile_editor_from_curl),
            onClick = onToggle,
            modifier = Modifier.padding(horizontal = tokens.screenPadding),
        )
        ...
        Column(
            ...
            AppTextField(
                state = curlText,
                label = stringResource(R.string.profile_editor_from_curl),
                singleLine = false,
                supportingText = stringResource(R.string.profile_editor_from_curl_hint),
            )
            if (failed) {
                AppText(
                    text = stringResource(R.string.profile_editor_curl_failed),
                    style = AppTextStyle.Footnote,
                    color = palette.error,
                )
            }
            if (droppedHeaders.isNotEmpty()) {
                AppText(
                    text = stringResource(
                        R.string.profile_editor_curl_dropped,
            ...
            AppTextButton(
                text = stringResource(R.string.profile_editor_parse),
                onClick = onParse,
            )
        }
    }
...
private fun AdvancedSection(bodyPatch: AppTextFieldState) {
    ...
    Column {
        ...
        Column(
            ...
            AppTextField(
                state = bodyPatch,
                label = stringResource(R.string.profile_editor_body_patch),
                singleLine = false,
                supportingText = stringResource(R.string.profile_editor_body_patch_hint),
            )
        }
    }
}

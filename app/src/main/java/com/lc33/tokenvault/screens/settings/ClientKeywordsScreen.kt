...
fun ClientKeywordsScreen(
    ...
    val deleteDesc = stringResource(R.string.probe_keywords_delete)

    SettingsSubPage(titleRes = R.string.probe_keywords, onBack = onBack) {
        item {
            AppCard(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                AppText(
                    text = stringResource(R.string.probe_keywords_hint),
        ...
        item { SectionTitle(text = stringResource(R.string.probe_keywords)) }

        if (items.isEmpty()) {
            item {
                AppText(
                    text = stringResource(R.string.probe_keywords_empty),
                    style = AppTextStyle.Secondary,
                    color = appSecondaryTextColor,
        ...
        item {
            AppTextField(
                state = input,
                label = stringResource(R.string.probe_keywords_add),
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = tokens.screenPadding, vertical = tokens.itemSpacing),
            )
        ...
        item {
            Row(
                ...
                AppTextButton(
                    text = stringResource(R.string.probe_keywords_add),
                    onClick = {
                ...
                AppTextButton(
                    text = stringResource(R.string.probe_thresholds_save),
                    onClick = {

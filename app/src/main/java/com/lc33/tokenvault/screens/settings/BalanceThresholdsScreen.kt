...
fun BalanceThresholdsScreen(
    ...
    SettingsSubPage(titleRes = R.string.probe_thresholds, onBack = onBack) {
        item {
            AppCard(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                AppText(
                    text = stringResource(R.string.probe_thresholds_hint),
        ...
        item {
            AppTextField(
                state = usdState,
                label = stringResource(R.string.probe_thresholds_usd),
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = tokens.screenPadding, vertical = tokens.itemSpacing),
                errorText = if (showError) stringResource(R.string.probe_thresholds_invalid) else null,
            )
        }
        ...
        item {
            AppTextField(
                state = cnyState,
                label = stringResource(R.string.probe_thresholds_cny),
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = tokens.screenPadding, vertical = tokens.itemSpacing),
                errorText = if (showError) stringResource(R.string.probe_thresholds_invalid) else null,

...
fun AboutScreen(onBack: () -> Unit) {
    ...
    BackHandler(enabled = showEncryptionDialog) { showEncryptionDialog = false }
        ...
        LazyColumn(
            ...
            item {
                AppCard(
                    ...
                    AppText(text = stringResource(R.string.app_name), style = AppTextStyle.Title)
                    AppText(
                        text = stringResource(
            ...
            item {
                AppArrowRow(
                    title = stringResource(R.string.about_encryption_row),
                    summary = stringResource(R.string.about_encryption_row_summary),
                    onClick = { showEncryptionDialog = true },
                )
            }
            item {
                AppArrowRow(
                    title = stringResource(R.string.about_not_password_manager_row),
                    summary = stringResource(R.string.about_not_password_manager_summary),
                )
            }
        }
    }
    ...
    AppDialog(
        ...
        title = stringResource(R.string.about_encryption_row),
        summary = stringResource(R.string.about_encryption_dialog_summary),

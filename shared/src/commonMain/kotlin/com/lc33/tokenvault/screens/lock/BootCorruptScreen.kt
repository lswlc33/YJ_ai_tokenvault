...
import tokenvault.shared.generated.resources.boot_corrupt_wipe_confirm
import tokenvault.shared.generated.resources.boot_corrupt_wipe_confirm_body
import tokenvault.shared.generated.resources.boot_corrupt_wipe_confirm_title
...
fun BootCorruptScreen(
    ...
    LockPage {
        LockPageHeader(
            title = stringResource(Res.string.boot_corrupt_title),
            subtitle = stringResource(Res.string.boot_corrupt_body),
        ...
        Column(
            ...
            AppText(
                text = stringResource(Res.string.boot_corrupt_untouched),
